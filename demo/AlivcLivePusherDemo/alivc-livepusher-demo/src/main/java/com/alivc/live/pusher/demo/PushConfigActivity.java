            ...
            switch (id) {
                case R.id.beginPublish:
                    if(getPushConfig() != null) {
                        LivePushActivity.startActivity(PushConfigActivity.this, mAlivcLivePushConfig, mUrl.getText().toString(), mAsyncValue, mAudioOnlyPush, mVideoOnlyPush, mOrientationEnum, mCameraId, isFlash);
                    }
                    break;
                case R.id.qr_code:
